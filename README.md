...
### Design Summary
The aim of this website's design is to make the user feel...

### Colour Scheme
[Colormind.io](http://colormind.io/) was used to generate the colorscheme for this website.  

### Fonts
Sans-serif was chosen as the back-up font - in case these fonts don't load - because of it's clear readability.
